  ...
  <div class="dashboard-container">
    <div class="content-wrapper">
      ...
      <div class="main-content">
        <h1 class="title">{{ $t("nurseAvailability.availability.title") }}</h1>
        <p class="subtitle">
          {{ $t("nurseAvailability.availability.subtitle") }}
        </p>
        ...
        <div class="calendar-container">
          <div class="calendar-header">
            ...
            <span
              >{{
                $t(
                  `nurseAvailability.availability.calendar.months.${currentMonth}`
                )
              }}
              {{ currentYear }}</span
            >
        ...
        <div class="availability-settings">
          <h3>{{ $t("nurseAvailability.availability.settings.title") }}</h3>
          <div class="input-group">
            <label>{{
              $t("nurseAvailability.availability.settings.selectedDays")
            }}</label>
            <input type="text" :value="selectedDates.join(', ')" disabled />
          </div>
          <div class="time-group">
            <label>{{
              $t("nurseAvailability.availability.settings.availableHours")
            }}</label>
            ...
            <span>
              {{ $t("nurseAvailability.availability.settings.from") }}
            </span>
          ...
          <button class="save-btn" @click="saveAvailability">
            {{ $t("nurseAvailability.availability.settings.save") }}
          </button>
        </div>
      </div>
    </div>
